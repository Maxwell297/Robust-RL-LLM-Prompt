...
style_classifier_dict = {
    ('yelp', None, 'train'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/yelp-bert-base-uncased-train/',
    ('yelp', None, 'test'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/yelp-bert-base-uncased-test/',
    ('shakespeare', 0, 'train'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/shakespeare-bert-base-uncased-train-100-0/',
    ('shakespeare', 1, 'train'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/shakespeare-bert-base-uncased-train-100-1/',
    ('shakespeare', 2, 'train'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/shakespeare-bert-base-uncased-train-100-2/',
    ('shakespeare', None, 'test'): '/cmlscratch/jryao/RLPrompt/text-style-transfer/style_classifiers/shakespeare-bert-base-uncased-test-all/'}
