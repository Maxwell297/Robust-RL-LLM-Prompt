...
ppl_lm_dict = {'yelp': '/cmlscratch/jryao/RLPrompt/text-style-transfer/evaluation/ppl/gpt2-yelp',
               'shakespeare': '/cmlscratch/jryao/RLPrompt/text-style-transfer/evaluation/ppl/gpt2-shakespeare'}
